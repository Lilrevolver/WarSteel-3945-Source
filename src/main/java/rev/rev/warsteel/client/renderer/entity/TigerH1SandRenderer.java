...
import rev.rev.warsteel.client.model.vehicle.TigerH1SandModel;
import rev.rev.warsteel.entity.vehicle.TigerH1SandEntity;
import software.bernie.geckolib.cache.object.GeoBone;

public class TigerH1SandRenderer extends VehicleRenderer<TigerH1SandEntity> {
    public TigerH1SandRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TigerH1SandModel());
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, TigerH1SandEntity animatable, GeoBone bone, RenderType renderType,
